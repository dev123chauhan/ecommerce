...
export const   footerData = [
    ...
    },
    {
      title: "Support",
      items: [
        { type: "text", content: "111 Bijoy sarani, Dhaka," },
        { type: "text", content: "DH 1515, Bangladesh." },
        { type: "text", content: "exclusive@gmail.com" },
    ...
    },
    {
      title: "Download App",
      items: [
        { type: "text", content: "Save $3 with App New User Only", className: "text-gray-400 text-sm" },
        {
          type: "custom",
          content: (
